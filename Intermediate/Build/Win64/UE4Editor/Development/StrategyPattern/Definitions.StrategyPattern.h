...
#define UE_PROJECT_NAME StrategyPattern
#define UE_TARGET_NAME StrategyPatternEditor
#define UE_MODULE_NAME "StrategyPattern"
...
#define STRATEGYPATTERN_API DLLEXPORT
